...
class ArrayHelperTest extends BaseCase
{
    ...
    public static function provideExtractStringFromArrayByName(): array
    {
        return [
            'string' => [
                'test_name',
    ...
    public static function provideExtractIntFromArrayByName(): array
    {
        return [
            'string' => [
                'test_name',
    ...
    public static function provideExtractBoolFromArrayByName(): array
    {
        return [
            'string' => [
                'test_name',
    ...
    public static function provideExtractArrayFromArrayByName(): array
    {
        return [
            'array' => [
                'test_name',
