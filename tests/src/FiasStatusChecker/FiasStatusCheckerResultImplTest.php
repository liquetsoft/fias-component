 ...
 * @internal
 */
class FiasStatusCheckerResultImplTest extends BaseCase
{
    /**
    ...
    public function provideCanProceed(): array
    {
        return [
            'can proceed' => [FiasStatusCheckerStatus::AVAILABLE, true],
            "can't proceed" => [FiasStatusCheckerStatus::NOT_AVAILABLE, false],
            'unknown proceed' => [FiasStatusCheckerStatus::UNKNOWN, false],
        ];
    }
}
